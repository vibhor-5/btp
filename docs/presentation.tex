    ...
    \begin{column}{0.50\textwidth}
      \begin{block}{FreshRetailNet-50K Scale \& Scope}
        ...
        \begin{itemize}
          ...
          \item \textbf{Feature Types}: Refined via IG analysis down to 6 highly-curated signals. \textbf{Demand Stream}: Sales, Discounts, Holidays, Momentum. \textbf{Inventory Stream}: Daily Stock Status, Rolling Stockouts.
        \end{itemize}
      \end{block}
