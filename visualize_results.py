...
def plot_metrics():
    # Data derived from the authentic SKU Backorder baseline run
    models = ['XGBoost', 'Random Forest']
    
    # Metrics
    roc_auc = [0.9300, 0.9328]
    precision = [0.08, 0.09]
    recall = [0.70, 0.63]
    f1_score = [0.15, 0.15]
    ...
    ax.set_title('Baseline Model Performance Comparison (SKU Backorder Dataset)')
    ax.set_xticks(x)
